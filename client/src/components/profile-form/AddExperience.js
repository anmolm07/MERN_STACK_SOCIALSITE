...
const AddExperience = ({ addExperience,history}) => {
    ...
    return (
        <Fragment>
            <h1 className="large text-second">
                Add An Experience
            </h1>
            <p className="lead">
            ...
            <form className="form" onSubmit={e => {
                ...
                <div className="form-group">
                    <p><input type="checkbox" name="current" checked={current} value={current}
                        onChange={() => setFormData({ ...formData, current: !current })} /> {' '}Current Job</p>
                </div>
                <div className="form-group">
                    <h4>To Date</h4>
                    <input type="date" name="to" value={to}
                        onChange={e => onChange(e)} disabled={current} />
                </div>
                <div className="form-group">
                    <textarea
                        name="description"
                ...
                <input type="submit" className="btn btn-second my-1" />
